...
const primeSprite =
  'https://res.cloudinary.com/dcywbu46z/image/upload/h_20,f_auto/v1550951658/amazon-FEC/prime.png';

const concatUrl = id =>
  `https://res.cloudinary.com/dcywbu46z/image/upload/w_160,h_160,f_auto/v1550899094/amazon-FEC/item-${id}.jpg`;
...
const Product = ({
  ...
  <div className={product.column}>
    ...
    <div className={product.row}>
      ...
      <span className={product.review_count}>{reviewCount}</span>
    </div>
    <div className={product.row}>
